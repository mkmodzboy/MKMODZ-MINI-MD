            ...
            if (connection === 'open') {
                ...
                if (!existingSession) {
                    await conn.sendMessage(userJid, {
                        ...
                        caption: `\n╭────────────────────◇\n│✦ *_🦋⍣⃝🤓 SILVER-TechX 🕊_ — CONNECTED* 🔥\n│✦ Type *${prefix}menu* to see all commands 💫\n│✦ Prefix 『 ${prefix} 』  Mode 〔${mode}〕\n╰────────────────────○\n*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ _🦋⍣⃝🤓 SILVER-TechX 🕊_*`
                    });
                }
            }
            if (connection === 'close') {
...
router.get('/ping', (req, res) => res.json({ status: 'active', message: 'SILVER-TechX MD is running 🔥', activeSessions: activeSockets.size }));
